...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="xuidCount">Number of Xuids in the avoid list.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="xuids">A caller allocated array of xuids to write the result into.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="resultSizeInBytes">The size in bytes required to store the permission check result.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="resultSizeInBytes">The size in bytes required to store the permission check results.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="buffer">A caller allocated byte buffer to write result into.</param>
/// <param name="ptrToBufferResults">Strongly typed array of XblPermissionCheckResult that points into buffer.  
/// Do not free this as its lifecycle is tied to buffer.</param>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="xuidCount">Number of Xuids in the mute list.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="xuids">A caller allocated array of xuids to write into.</param>
/// <returns>HRESULT return code for this API operation.</returns>
