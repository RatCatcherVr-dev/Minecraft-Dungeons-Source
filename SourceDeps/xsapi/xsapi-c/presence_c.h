...
typedef struct XblPresenceQueryFilters
{
    ...
    /// <summary>
    /// Detail level of the result. Defaults to all details.
    /// </summary>
...
/// <param name="xuid">Xuid the record is associated with.</param>
...
/// </summary>
/// <param name="handle">Handle for the presence record returned from a GetPresence API.</param>
/// <param name="userState">A caller allocated struct to be filled with the presence state of the record.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle for the presence record returned from a GetPresence API.</param>
/// <param name="deviceRecords">Returns a pointer to an array of device presence records.  
...
/// <param name="deviceRecordsCount">Returns the size of the returned array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="resultCount">Number of presence records returned.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="presenceRecordHandles">A caller allocated array of handles to write the result into.  
...
/// <param name="subscriptionHandle">Handle for the subscription that will be used to unsubscribe.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="xblContextHandle">Xbox live context for the local user.</param>
/// <param name="subscriptionHandle">Handle for the subscription created with <see cref="XblPresenceSubscribeToDevicePresenceChange"/>.  
