...
/// </summary>
/// <param name="call">The handle of the HTTP call.</param>
/// <param name="type">The response body type to read the results of this HTTP call. Note: this does not influence 
/// the content-type header, which must be supplied by calling XblHttpCallRequestSetHeader.</param>
...
/// This must be called prior to calling XblHttpCallPerformAsync.
/// </summary> 
/// <param name="call">The handle of the HTTP call.</param>
...
/// <summary>
/// Sets a flag which defines the HTTP call as long or not. Timeout values for long versus short can be configured in the XblContext.  
/// Defaults to false.  
/// This must be called prior to calling XblHttpCallPerformAsync.
/// </summary>
/// <param name="call">The handle of the HTTP call.  Pass nullptr to set the default for future calls.</param>
...
/// The memory for the returned string pointer remains valid for the life of the XblHttpCallHandle object until XblHttpCallCloseHandle() is called on it.
/// </param>
/// <returns>Result code for this API operation.  Possible values are S_OK, E_INVALIDARG, or E_FAIL.</returns>
/// <remarks>
...
/// <returns>Result code for this API operation.  Possible values are S_OK, E_INVALIDARG, or E_FAIL.</returns>
/// <remarks>
/// Use XblHttpCallResponseGetNumHeaders() to know how many response headers there are in the HTTP call.
/// </remarks>
