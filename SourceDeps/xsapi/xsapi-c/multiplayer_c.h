...
enum class XblMatchmakingStatus : uint32_t
{
    ...
    /// <summary>
    /// Indicates the matchmaking search is not specified.  This status is optional and requires the clientMatchmaking capability.
    /// </summary>
    None,
...
typedef struct XblMultiplayerSessionConstants
{
    ...
    /// <summary>
    /// If a member_initialization object is set, the session expects the client system or title to perform
    /// initialization following session creation. The timeouts and initialization stages are automatically tracked by
    /// the session, including initial QoS if any metrics are set. Will be null if it is not set.
    /// </summary>
...
/// </summary>
/// <param name="sessionReference">The session reference.</param>
/// <param name="sessionReferenceUri">The URI representation of the session reference.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <summary>
/// Represents a category of roles for a muliplayer session.
/// </summary>
typedef struct XblMultiplayerRoleType
{
    ...
    /// <summary>
    /// Which role settings for roles in this role type can be modified throughout the life of the session. Exclude role settings to lock them.
    /// </summary>
...
typedef struct XblMultiplayerSessionMember
{
    ...
    /// <summary>
    /// QoS measurements by secure device address. Like all fields, "measurements" must be updated as a whole.  
...
typedef struct XblMultiplayerSessionQuery
{
    ...
    /// <summary>
    /// Optional. Filter result to just sessions these Xbox User IDs in it.  
    ...
    /// <summary>
    /// Optional. Filter result to just sessions with this keyword.  
    /// You must specify at least one Xuid filter OR a keyword filter.
    /// </summary>
...
/// Tags must be alphanumeric and start with a letter. They're case-insensitive.
/// </summary>
...
/// <summary>
/// Handle to a local multiplayer session. This handle will be used to query and change the local session object.  
/// Anytime the changes made to the local session object will not be reflected in the multiplayer service
/// until a subsequent call to XblMultiplayerWriteSession.
/// </summary>
...
/// <summary>
/// Creates a new local multiplayer session. You must call XblMultiplayerWriteSession after this to write batched local changes to the service.  
/// If this is called without XblMultiplayerWriteSession, this will only create a local session object but does not commit it to the service.  
/// When the local session object is no longer needed, call <see cref="XblMultiplayerSessionCloseHandle"/>.
/// </summary>
// TODO should we just take an XblContextHandle instead?
...
/// <summary>
/// Get the info about session initialization. If the session is not doing member initialization, nullptr will be returned.
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="deviceTokens">Returns a pointer to the array of candidate device tokens.  
...
/// <param name="deviceTokensCount">Size of the returned deviceTokens array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="measurementServerAddressesJson">The Json that represent the measurement server addresses. Example JSON:
/// {
///   "server farm a": {
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="sessionCloudComputePackageConstantsJson">Cloud compute instance to be allocated on behalf of the session. Example Json:
/// {
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="roleTypes">Returns a pointer to an array of roleTypes.  
/// The memory for the returned pointer remains valid for the life of the XblMultiplayerSessionHandle object until it is closed.
/// </param>
/// <param name="roleTypesCount">The number of roles types in the roleTypes array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <summary>
/// Fetches the XblMultiplayerRole object by role type name and role name. If no such role exists, nullptr is returned.
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="roleTypeName">Name of the role type the role belongs to.</param>
/// <param name="roleName">Name of the role.</param>
/// <param name="role">Returns a pointer to the role object with info about the role.  
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// Note that newly created sessions will not have role info populated until the XblMultiplayerWriteSession is called.
/// </remarks>
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="members">Returns a pointer to array of session member ojects.
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <param name="membersCount">The size of the returned array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <summary>
/// Gets the session member with a specified MemberId. If there is no member with the specified Id nullptr is returned.
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="memberCustomConstantsJson">The custom constants to set for this member. This is the only time the member's constants can be set.</param>
/// <param name="initializeRequested">True if the system should perform managed initialization, and false otherwise.</param>
...
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="locked">True if the session should be lock, false otherwise.</param>
/// <returns></returns>
...
/// Set to MultiplayerSessionChangeTypes_None to clear the subscription.
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
...
/// <summary>
/// With the user who either created or got the session, leave the session.  
...
/// <summary>
/// Set the current user to active or inactive.  You cannot set the the user to reserved or ready in this manner.  
/// Use XblMultiplayerSessionAddMemberReservation to add a member reservation.  
...
/// <param name="address">The formatted secure device address.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <summary>
/// Sets a collection of XblMultiplayerQosMeasurements for the members.  This is only useful when the title is manually managing QoS.  
/// If the platform is automatically performing QoS, this does not need to be called.
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="measurements">Json representing the QoS measurements of members. Example Json:
/// {
...
/// <summary>
/// Sets measurements JSON for the servers.  This is only useful when the title is manually managing QoS.  
/// If the platform is automatically performing QoS, this does not need to be called.
/// </summary>
/// <param name="handle">Handle to the multiplayer session.</param>
/// <param name="measurements">The JSON that represents the server measurements. Example Json:
/// {
///   "server farm a": {
...
/// Useful to compare a session object passed to XblMultiplayerWriteSession with the session object returned.
/// </summary>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="sessionRef">Associated session reference.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="id">Search handle Id.  
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="xuids">Pointer to array of xuids.  
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <param name="xuidsCount">Count of xuids in the array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="tags">Pointer to array of tags.  
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <param name="tagsCount">Count of tags in the array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="attributes">Pointer to array of attributes.  
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <param name="attributesCount">Count of attributes in the array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="visibility">Visibility of the associated session.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="joinRestriction">Join restriction of the associated session.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="closed">Whether the session is closed or not.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="maxMembers">Max members allowed in session.</param>
/// <param name="currentMembers">Current number of members in session.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="creationTime">Time the serach handle was created in MPSD (not the local object).</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="handle">Handle to the search handle details.</param>
/// <param name="customPropertiesJson">Custom properties JSON string.  
/// The memory for the returned pointer will remain valid for the life of the XblMultiplayerSessionHandle object until it is closed.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <summary>
/// Writes a new or updated multiplayer session to the service.  The session must have a valid session reference.  
...
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="handle">
/// The returned handle is for a new instance of a local multiplayer session object.  It must be release by the caller with
/// <see cref="XblMultiplayerSessionCloseHandle"/>.  If the updated session object is not needed, passing nullptr will cause the new multiplayer
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="handle">The returned handle is for a new instance of a local multiplayer session object.  
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="sessionCount">The number of matching sessions.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="sessions">A caller allocated array to write the results to.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <summary>
/// Gets the result of a XblMultiplayerSetTransferHandleAsync operation.  The returned value is the ID of the created MPSD transfer handle.
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="handleId">The unique ID for the MPSD handle.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="handle">Handle to the local search handle object.  
...
/// </summary>
/// <param name="xblContext">Xbox live context for the local user.</param>
/// <param name="handleId">Id of the search handle to delete. Obtained from either the search handle or session handle.</param>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="searchHandleCount">Number of search results.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="searchHandles">A caller allocated array of write the results into.  
...
/// The ID string must be prefixed with "///".  Pass nullptr if you don't want a custom string added to the invite.</param>
...
/// <param name="handles">A caller allocated array of XblMultiplayerInviteHandle to write the results into.  
...
/// <param name="async">The AsyncBlock for this operation.</param>
/// <param name="activityCount">The number of activity objects returned.</param>
/// <param name="activities">Array of activities objects to populate.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <summary>
/// Starts or stops the multiplayer service connectivity via RTA, for two purposes:  
...
// TODO should these callback registrations require a context or should they be global
/// <summary>
...
/// <summary>
/// Registers an event handler for notifications when the multiplayer connection id changes. Use the returned XblFunctionContext
