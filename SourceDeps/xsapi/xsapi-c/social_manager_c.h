...
{
    /// <summary>
    /// Users added to social graph.
    /// </summary>
    UsersAddedToSocialGraph,

    /// <summary>
    /// Users removed from social graph.
    /// </summary>
    UsersRemovedFromSocialGraph,

    /// <summary>
    /// Users presence record has changed.
    /// </summary>
    PresenceChanged,
    ...
    /// <summary>
    /// Relationship to users has changed.
    /// </summary>
    SocialRelationshipsChanged,

    /// <summary>
    /// Social graph load complete from adding a local user.
    /// </summary>
    LocalUserAdded,

    /// <summary>
    /// Xbox Social User Group load complete (will only trigger for views that take a list of users).
    /// </summary>
    SocialUserGroupLoaded,

    /// <summary>
    /// Social user group updated.
    /// </summary>
...
/// <param name="type">Returned group type.</param>
...
/// </summary>
/// <param name="group">The group handle.</param>
/// <param name="localUser">Returned user handle.
/// This user handle does not need to be closed.
/// It remains valid for as long as the user is added to added to social manager
/// </param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// Call this API after calling either <see cref="XblSocialManagerCreateSocialUserGroupFromFilters"/>
...
/// </summary>
/// <param name="group">The group handle.</param>
/// <param name="presenceFilter">Returned presence filter.</param>
/// <param name="relationshipFilter">Returned relationship filter.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <param name="users">Returns a pointer to an array of XblSocialManagerUser objects.  
/// The memory for the returned pointer remains valid until the next time <see cref="XblSocialManagerDoWork"/> is called.</param>
/// <param name="usersCount">Size of the users array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <param name="trackedUsers">Returns a pointer to tracked xuids array.
/// The memory for the returned pointer remains valid until the next time <see cref="XblSocialManagerDoWork"/> is called.</param>
/// <param name="trackedUsersCount">Size of the tracked users array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// </summary>
/// <param name="socialEvents">Returns a pointer to the array of social events that have occurred since the last call to XblSocialManagerDoWork.  
...
/// <param name="socialEventsCount">The number of events in the social events array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// If the social events array is null, no results.  If the social events count is 0, no results.  
...
/// <param name="group">A handle to the created group. This group can be later be cleaned up with XblSocialManagerDestroySocialUserGroup.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <param name="xboxUserIdList">List of users to populate the Xbox Social User Group with. The list cannot exceed XBL_SOCIAL_MANAGER_MAX_USERS_FROM_LIST.</param>
/// <param name="xboxUserIdListCount">The number of items in the xboxUserIdList.</param>
/// <param name="group">A handle to the created group. This group may later be cleaned up with XblSocialManagerDestroySocialUserGroup.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// The result of a user group being loaded will be triggered through
/// the <see cref="XblSocialManagerEventType"/>::SocialUserGroupLoaded event in <see cref="XblSocialManagerDoWork"/>.
...
/// <param name="users">Returns a pointer to an array to populate with local users.  
/// This array is only valid until the next call to XblSocialManagerDoWork.  
