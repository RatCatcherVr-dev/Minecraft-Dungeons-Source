...
/// the next page of results from the service if there is is one. The handle must be closed using 
/// <see cref="XblSocialRelationshipResultCloseHandle"/> when the result is no longer needed.
/// </remarks>
...
/// <param name="maxItems">The maximum number of items that the results list can contain. Pass 0 to attempt to retrieve all items.</param>
...
/// <param name="handle">Sends back an XblSocialRelationshipResultHandle.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <param name="relationships">Pointer to an array of XblSocialRelationship objects.  
...
/// <param name="relationshipsCount">Sends back the number of items in the relationships array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// When no longer using the XblSocialRelationshipResultHandle, make sure to call <see cref="XblSocialRelationshipResultCloseHandle"/>.  
/// When all outstanding handles have been closed, the memory associated with the social relationship's results list will be freed.
...
/// <param name="hasNext">Sends back true if there are more results to retrieve, false otherwise.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <param name="totalCount">Sends back the total number of results for the query.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// <param name="handle">Sends back a XblSocialRelationshipResultHandle.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// When no longer using the XblSocialRelationshipResultHandle, make sure to call <see cref="XblSocialRelationshipResultCloseHandle"/>.  
/// When all outstanding handles have been closed, the memory associated with the social relationship's results list will be freed.  
...
/// <param name="duplicatedHandle">Sends back the duplicated handle.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// When no longer using the XblSocialRelationshipResultHandle, make sure to call <see cref="XblSocialRelationshipResultCloseHandle"/>.
/// </remarks>
...
/// <param name="subscriptionHandle">A handle to the subscription which is used to un-subscribe.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
typedef struct XblReputationFeedbackItem
{
    ...
    /// <summary>
    /// (Optional) Multiplayer session reference describing the MPSD session this feedback relates to.
    /// </summary>
