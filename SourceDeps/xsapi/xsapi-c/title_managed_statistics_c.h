...
typedef struct XblTitleManagedStatistic
{
    ...
    /// <summary>
    /// The value of the double statistic.
    /// </summary>
    double numberValue;
...
/// <summary>
/// Completely updates the calling user's stats. This call wipes out all existing stats - any
/// stats not referenced in the provided array will be removed.
/// </summary>
...
/// <summary>
/// Partial update to the calling user's stats. Stats will be overwritten if they exist already, but
/// any stats not referenced will remain unchanged. Note that stat names are case insensitive.
/// </summary>
/// <param name="xblContextHandle">Xbox live context for the local user.</param>
/// <param name="statistics">A list of XblTitleManagedStatistic to submit.</param>
/// <param name="statisticsCount">Number of items in the statistics array.</param>
...
/// <summary>
/// Delete stats for the calling user. Any stats not referenced will remain unchanged. Note that stat names
/// are case insensitive.
/// </summary>
/// <param name="xblContextHandle">Xbox live context for the local user.</param>
/// <param name="statisticNames">A list of names of statistics to delete. If there isn't an existing
/// statistic matching a provided name, no changes will be made for that statistic.</param>
