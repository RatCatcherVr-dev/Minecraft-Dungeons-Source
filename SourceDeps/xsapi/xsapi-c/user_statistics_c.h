...
/// <param name="ptrToBuffer">Strongly typed pointer that points into buffer.  
/// Do not free this as its lifecycle is tied to buffer.</param>
/// <param name="resultsCount">The number of results.</param>
/// <param name="bufferUsed">Number of bytes written to the buffer.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks></remarks>
...
/// <param name="buffer">A caller allocated byte buffer to write result into.</param>
/// <param name="ptrToBufferResults">Strongly typed array of XblUserStatisticsResult that points into buffer.  
/// Do not free this as its lifecycle is tied to buffer.</param>
/// <param name="resultsCount">The number of results.</param>
/// <param name="bufferUsed">Number of bytes written to the buffer.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="subscriptionHandle">>A XblRealTimeActivitySubscriptionHandle object that contains the state of the subscription.  
