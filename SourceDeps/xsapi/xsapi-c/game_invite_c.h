...
typedef struct XblGameInviteNotificationEventArgs
{
    ...
    /// <summary>
    /// Invite Handle ID
    /// The memory for the returned string pointer only remains valid inside the XblGameInviteHandler so deep copy the string if you need to refer to it outside the handler.
    /// </summary>
