...
/// <summary>
/// Represents a reference to a member in a multiplayer game.  The member objects are created and owned by MultiplayerManager.  
...
typedef struct XblMultiplayerEvent
{
    ...
    /// you can then retrieve the latest lobby or game session.
    /// </summary>
...
/// XblMultiplayerEventType::JoinLobbyCompleted - Invited Xbox User ID of the member that the invite was sent for.</param>
...
/// </summary>
/// <param name="argsHandle">The event args handle from the XblMultiplayerEvent.</param>
/// <param name="memberCount"> The required size for the members array for XblMultiplayerEventArgsMembers().</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// The memory for the returned pointer remains valid for the life of the XblMultiplayerEventArgsHandle object until it is closed.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="argsHandle">The event args handle from the XblMultiplayerEvent.</param>
/// <param name="matchStatus">A caller allocated struct to be filled with current matchmaking status.</param>
/// <param name="initializationFailureCause">A caller allocated struct to be filled with the cause of why 
...
/// </summary>
/// <param name="argsHandle">The event args handle from the XblMultiplayerEvent.</param>
/// <param name="registrationState">A caller allocated struct to be filled with the tournament team registration state.</param>
/// <param name="registrationReason">A caller allocated struct to be filled with the tournament team registration reason for the certain registration states.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="argsHandle">The event args handle from the XblMultiplayerEvent.</param>
/// <param name="startTime">Game's start time for the tournament.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="argsHandle">The event args handle from the XblMultiplayerEvent.</param>
/// <param name="performQoSMeasurementsArgs">A caller allocated struct to be filled with the 
...
/// </summary>
/// <param name="multiplayerEvents">
/// An array of all events for the game to handle. Will be null if no events are triggered during this update.
/// The returned events are owned by MultiplayerManager and are valid until XblMultiplayerManagerDoWork is called again.
/// </param>
/// <param name="multiplayerEventsCount">The number of events in the multiplayerEvents array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// </summary>
/// <param name="correlationId">The unique ID given to the session.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="localMembers">A caller allocated array of XblMultiplayerManagerMember to write into.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="hostMember">A caller allocated struct to be filled with the host member.</param>
...
/// <param name="customActivationContext">The activation context string. A game defined string 
/// that is passed to the invited game client and interpreted as desired.  A game defined string 
/// that is passed to the invited game client and interpreted as desired. (Optional)</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
...
/// It ensures that updates to the session are atomic.  If writing to non-sharable properties, use XblMultiplayerManagerGameSessionSetProperties() instead.  
/// The service may reject your request if a race condition occurred (due to a conflict) resulting in HTTP_E_STATUS_PRECOND_FAILED (HTTP status 412).  
/// To resolve this, evaluate the need to write again and re-submit if needed.  
/// The result is delivered via XblMultiplayerEvent of type XblMultiplayerEventType::SessionSynchronizedPropertyWriteCompleted 
/// through XblMultiplayerManagerDoWork().
...
/// 'XblMultiplayerMatchStatus::None' if no matchmaking is in progress.
/// </summary>
/// <returns>The current status of matchmaking.</returns>
...
/// Json representing the QoS measurements. Example Json:
