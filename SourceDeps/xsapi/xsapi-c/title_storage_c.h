...
/// <param name="items">Pointer to an array of XblTitleStorageBlobMetadata objects.  
/// The memory for the returned pointer remains valid for the life of the XblTitleStorageBlobMetadataResultHandle object until it is closed.
/// </param>
/// <param name="itemsCount">The count of objects in the returned array.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// This memory of the list is freed when the XblTitleStorageBlobMetadataResultHandle is closed 
/// with XblTitleStorageBlobMetadataResultCloseHandle.
/// </remarks>
...
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// To retrieve the next page of items, call XblTitleStorageBlobMetadataResultGetNextAsync.
/// </remarks>
...
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// To get the result, call XblTitleStorageBlobMetadataResultGetNextResult inside the AsyncBlock callback
...
/// <param name="result">Returns the next XblTitleStorageBlobMetadataResultHandle.  
...
/// <param name="usedBytes">Number of bytes used in title storage of type StorageType.</param>
/// <param name="quotaBytes">Maximum number of bytes that can be used in title storage of type StorageType.  
...
/// <param name="result">lTitle storage blob metadata result handle.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// To get the result, call XblTitleStorageDownloadBlobResult inside the AsyncBlock callback
/// or after the AsyncBlock is complete.  
...
/// <param name="blobMetadata">A caller allocated XblTitleStorageBlobMetadata object to write result to.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// Larger sizes are preferred by the service.  If timeouts occur, the app should retry with a smaller size.  
/// Block size must be within the 1K to 4MB range.  This method will use a default size if this parameter is not within the acceptable range.  
