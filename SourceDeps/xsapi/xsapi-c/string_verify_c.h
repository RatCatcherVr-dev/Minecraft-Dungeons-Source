...
/// </summary>
/// <param name="asyncBlock">The AsyncBlock for this operation.</param>
/// <param name="resultSizeInBytes">The size in bytes required to store the XblVerifyStringResult result.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// </summary>
/// <param name="asyncBlock">The AsyncBlock for this operation.</param>
/// <param name="resultSizeInBytes">The size in bytes required to store the XblVerifyStringResult results.</param>
/// <returns>HRESULT return code for this API operation.</returns>
...
/// <param name="buffer">A caller allocated byte buffer to write result into.</param>
/// <param name="ptrToBufferStrings">Strongly typed array of XblVerifyStringResult that points into buffer.
/// Do not free this as its lifecycle is tied to buffer.</param>
/// <param name="stringsCount">Number of XblVerifyStringResult results.</param>
/// <param name="bufferUsed">Number of bytes written to the buffer.</param>
/// <returns>HRESULT return code for this API operation.</returns>
