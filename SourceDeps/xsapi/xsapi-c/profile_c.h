...
/// </summary>
/// <param name="async">The same AsyncBlock that passed to XblProfileGetUserProfilesAsync.</param>
/// <param name="profilesCount">Size of the caller allocated profiles array.  
/// Use <see cref="XblProfileGetUserProfilesResultCount"/> to get the count required.</param>
/// <param name="profiles">A caller allocated array of XblUserProfile objects to write the result into.</param>
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// The number of profiles returned can be obtained with <see cref="XblProfileGetUserProfilesResultCount"/>.
/// </remarks>
...
/// <returns>HRESULT return code for this API operation.</returns>
/// <remarks>
/// The number of profiles returned can be obtained with <see cref="XblProfileGetUserProfilesForSocialGroupResultCount"/>.
/// </remarks>
