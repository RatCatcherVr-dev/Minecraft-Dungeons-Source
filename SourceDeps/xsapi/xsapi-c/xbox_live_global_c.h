...
/// </summary>
/// <param name="args">Contains information about the HTTP call that failed. The fields are only valid until the callback returns.</param>
...
/// <summary>
/// Sets the registration token received when app registers with APNS.
/// </summary>
/// <param name="registrationToken">The current registration token</param>
STDAPI XblSetNotificationRegistrationToken(
