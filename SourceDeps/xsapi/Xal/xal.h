...
/// </summary>
/// <param name="userContext">Client provided context for the user.</param>
/// <param name="async">The AsyncBlock for this operation.</param>
/// <returns>Result code for this API operation.</returns>
/// <remarks>
/// The userContext pointer will be stored in the user and passed to all
/// XalPlatform* callbacks related to this user.
/// </remarks>
...
/// <returns>Result code for this API operation.</returns>
/// <remarks>
/// This function may need to show ui to the user.
///
/// The userContext pointer will be stored in the user and passed to all
/// XalPlatform* callbacks related to this user.
/// </remarks>
