...
/// <summary>
/// Registers the user handle to context event handler.
/// </summary>
...
/// </param>
/// <param name="handler">Pointer to the event handler to be set.</param>
/// <returns>Result code for this API operation.</returns>
/// <remarks>
/// Must be called before XalInitialize.
/// </remarks>
HRESULT XalPlatformSetUserHandleToContextEventHandler(
    _In_opt_ XTaskQueueHandle queue,
    _In_opt_ void* context,
    _In_ XalPlatformUserHandleToContextEventHandler* handler
) noexcept;
