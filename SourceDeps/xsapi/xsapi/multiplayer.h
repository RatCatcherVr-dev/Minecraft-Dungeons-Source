...
{
public:
    inline tournament_reference(const XblTournamentReference& tournamentReference);

    /// <summary>
    /// The definition name of the tournament.
    /// </summary>
    inline string_t definition_name() const;

    /// <summary>
    /// The tournament ID specific to the tournament.
    /// </summary>
    inline string_t tournament_id() const;

    /// <summary>
    /// The organizer name of the tournament.
    /// </summary>
    inline string_t organizer() const;
...
private:
    XblTournamentReference m_tournamentReference;
};

class tournament_team_result
{
public:
    inline tournament_team_result(_In_ tournament_game_result_state state = tournament_game_result_state::no_contest, _In_ uint64_t ranking = 0);

    /// <summary>
    /// The state of the result for the team
    /// </summary>
    inline tournament_game_result_state state() const;

    /// <summary>
    /// The ranking of the result
    /// </summary>
    inline uint64_t ranking() const;

    /// <summary>
    /// set the state of the result for the team
    /// </summary>
    inline void set_state(_In_ tournament_game_result_state state);

    /// <summary>
    /// set the ranking of the result
    /// </summary>
    inline void set_ranking(_In_ uint64_t ranking);

    /// <summary>
    /// Internal function
    /// </summary>
    inline tournament_team_result(_In_opt_ const XblTournamentTeamResult* teamResult);

    /// <summary>
    /// Internal function
    /// </summary>
    inline tournament_team_result(_In_ const XblTournamentGameResultWithRank& gameResult);

private:
    XblTournamentGameResultWithRank m_result;
};
...
private:
    ...
    rapidjson::Document m_customJson;
    web::json::value m_customJsonWeb;
    rapidjson::Document m_measurementsJson;
...
public:
    ...
    /// True if team capability is set on the session for a tournament.
    /// </summary>
    inline bool capabilities_team() const;
    ...
    /// True if arbitration capability is set on the session for a tournament.
    /// </summary>
    inline bool capabilities_arbitration() const;
...
public:
    ...
    /// </summary>
    inline utility::datetime arbitration_start_time() const;

    /// <summary>
    /// The state of the result
    /// </summary>
    inline xbox::services::tournaments::tournament_arbitration_state result_state() const;

    /// <summary>
    /// The source of the result
    /// </summary>
    inline xbox::services::tournaments::tournament_game_result_source result_source() const;

    /// <summary>
    /// A value from 0-100 that indicates the confidence level of this result
    /// </summary>
    inline uint32_t result_confidence_level() const;

    /// <summary>
    /// The results of the game
    /// </summary>
    inline std::unordered_map<string_t, xbox::services::tournaments::tournament_team_result> results() const;

    /// <summary>
    /// Internal function
    /// </summary>
    inline multiplayer_session_arbitration_server(XblMultiplayerSessionHandle sessionHandle);
    inline multiplayer_session_arbitration_server(const multiplayer_session_arbitration_server& other);
    inline multiplayer_session_arbitration_server& operator=(multiplayer_session_arbitration_server other);
    inline ~multiplayer_session_arbitration_server();

private:
    XblMultiplayerSessionHandle m_sessionHandle;
    const XblMultiplayerArbitrationServer* m_arbitrationServer;
};
...
public:
    ...
    /// </summary>
    inline xbox::services::tournaments::tournament_reference tournament_reference() const;

    /// <summary>
    /// The teams in the tournament
    /// </summary>
    inline std::unordered_map<string_t, multiplayer_session_reference> teams() const;

    /// <summary>
    /// The tournament registration state of the team.
    /// </summary>
    inline xbox::services::tournaments::tournament_registration_state registration_state() const;

    /// <summary>
    /// The tournament registration reason for the certain state.
    /// </summary>
    inline xbox::services::tournaments::tournament_registration_reason registration_reason() const;

    /// <summary>
    /// Next game's start time for the tournament.
    /// </summary>
    inline utility::datetime next_game_start_time() const;

    /// <summary>
    /// Next game session reference for the tournament.
    /// </summary>
    inline multiplayer_session_reference next_game_session_reference() const;

    /// <summary>
    /// The last game's end time for the tournament.
    /// </summary>
    inline utility::datetime last_game_end_time() const;

    /// <summary>
    /// The last game's state for the tournament.
    /// </summary>
    inline xbox::services::tournaments::tournament_team_result last_team_result() const;

    /// <summary>
    /// The source for the last game's state of the tournament.
    /// </summary>
    inline xbox::services::tournaments::tournament_game_result_source last_game_result_source() const;

    /// <summary>
    /// Internal function
    /// </summary>
    inline multiplayer_session_tournaments_server(XblMultiplayerSessionHandle sessionHandle);
    inline multiplayer_session_tournaments_server(const multiplayer_session_tournaments_server& other);
    inline multiplayer_session_tournaments_server& operator=(multiplayer_session_tournaments_server other);
    inline ~multiplayer_session_tournaments_server();

private:
    XblMultiplayerSessionHandle m_sessionHandle;
    const XblMultiplayerTournamentsServer* m_server;
};
...
public:
    ...
    /// </summary>
    _XSAPIIMP_DEPRECATED inline std::unordered_map<string_t, multiplayer_role_type> role_types() const;
...
public:
    ...
    /// </summary>
    _XSAPIIMP_DEPRECATED inline std::vector<string_t> keywords() const;
...
public:
    ...
    /// </summary>
    inline xbox::services::tournaments::tournament_arbitration_status arbitration_status() const;
    ...
    /// <summary>
    /// DEPRECATED  - Tournaments are no longer supported by multiplayer.
    /// </summary>
    _XSAPIIMP_DEPRECATED inline std::unordered_map<string_t, xbox::services::tournaments::tournament_team_result> results() const;
    ...
    /// </summary>
    inline multiplayer_session_reference tournament_team_session_reference() const;
...
public:
    ...
    /// </summary>
    inline multiplayer_session_tournaments_server tournaments_server() const;

    /// <summary>
    /// An arbitration server that contains properties associated with a tournament games results.
    /// </summary>
    inline multiplayer_session_arbitration_server arbitration_server() const;
    ...
    inline std::error_code set_arbitration_timeouts(
    ...
    /// DEPRECATED - Tournaments are no longer supported by multiplayer.
    /// </summary>
    _XSAPIIMP_DEPRECATED inline std::error_code set_current_user_member_arbitration_results(
