...
public:
    ...
    /// </returns>
    inline xbox_live_result<std::shared_ptr<social_relationship_change_subscription>> subscribe_to_social_relationship_change(
        _In_ const string_t& xboxUserId
    );
    ...
    inline xbox_live_result<void> unsubscribe_from_social_relationship_change(
