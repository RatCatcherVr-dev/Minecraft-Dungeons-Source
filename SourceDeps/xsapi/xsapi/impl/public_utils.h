...
struct Utils
{
    ...
    static std::string SerializeJson(const rapidjson::Value& json)
    {
    ...
    static rapidjson::Document RapidJsonFromWebJson(_In_ const web::json::value& json)
    {
    ...
    static web::json::value WebJsonFromRapidJson(_In_ const rapidjson::Value& json)
    {
        return web::json::value::parse(Utils::StringTFromUtf8(Utils::SerializeJson(json).c_str()));
    }

    static const rapidjson::Value& ExtractJsonField(
