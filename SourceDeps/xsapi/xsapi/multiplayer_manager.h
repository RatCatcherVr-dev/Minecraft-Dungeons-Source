...
public:
    ...
    /// </summary>
    inline xbox::services::tournaments::tournament_team_result last_tournament_team_result() const;
...
public:
    ...
    /// <summary>
    /// DEPRECATED - Tournaments are no longer supported by multiplayer manager.
    /// </summary>
    _XSAPIIMP_DEPRECATED inline std::unordered_map<string_t, multiplayer_session_reference> tournament_teams() const;

    /// <summary>
    /// DEPRECATED - Tournaments are no longer supported by multiplayer manager.
    /// </summary>
    _XSAPIIMP_DEPRECATED inline std::unordered_map<string_t, xbox::services::tournaments::tournament_team_result> tournament_team_results() const;
...
public:
    ...
    /// </summary>
    _XSAPIIMP string_t invited_xbox_user_id() const
    {
        return GetXuid();
    }
};
...
public:
    ...
    /// Internal function
    /// </summary>
    tournament_registration_state_changed_event_args(XblMultiplayerEventArgsHandle handle) : multiplayer_event_args(handle) {}
...
public:
    ...
    /// Internal function
    /// </summary>
    tournament_game_session_ready_event_args(XblMultiplayerEventArgsHandle handle) : multiplayer_event_args(handle) {}
