...
#elif defined(WEBRTC_WIN) || defined(__native_client__) || defined(WEBRTC_ORBIS)
...
#endif  // defined(WEBRTC_WIN)
#if defined(__native_client__) || defined(WEBRTC_ORBIS)
...
#elif defined(WEBRTC_POSIX) || defined(WEBRTC_SWITCH)
#include <endian.h>
#include <stdlib.h>
#else
