...
class RTC_EXPORT PeerConnectionInterface : public rtc::RefCountInterface {
 public:
  ...
  struct RTC_EXPORT RTCConfiguration {
	...
	// If set, best efforts will be made to allocate candidate ports within this range.
	int preferred_candidate_udp_min_port = 0;
	int preferred_candidate_udp_max_port = 0;
  };
