...
#include "DungeonsBorder.generated.h"
 ...
 */
UCLASS()
class DUNGEONS_API UDungeonsBorder : public UContentWidget
{
...
public:
	...
	bool IsImageVisible(ESlateVisibility InVisibility);
