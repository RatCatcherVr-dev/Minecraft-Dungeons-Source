...
#include "MissionPrimaryDataAssetBase2.generated.h"


UCLASS(Abstract)
class DUNGEONS_API UMissionPrimaryDataAssetBase2 : public UPrimaryDataAsset
{
	GENERATED_BODY()
protected:
	virtual TArray<FString> GetFilenames() const { return {}; };
