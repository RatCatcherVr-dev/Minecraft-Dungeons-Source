...
#include "PropertyPrimaryDataAsset.generated.h"

/**
 * 
 */
UCLASS(BlueprintType)
class DUNGEONS_API UPropertyPrimaryDataAsset : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
#endif
public:
	UPropertyPrimaryDataAsset();

	static const FName DecorBundle;
