...
//using FXmppRelayTokenPtr = TSharedPtr<class FXmppRelayTokenStrophe, ESPMode::ThreadSafe>;
...
public:
	...
	virtual FXmppRelayTokenPtr RelayToken() override;
...
protected:
	...
	FXmppRelayTokenPtr RelayTokenStrophe;
};
