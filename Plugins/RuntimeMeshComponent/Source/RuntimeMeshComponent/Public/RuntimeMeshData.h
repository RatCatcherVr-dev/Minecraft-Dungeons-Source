...
private:
	...
	void CheckUpdate(bool bUseHighPrecisionTangents, bool bUseHighPrecisionUVs, int32 NumUVs, bool b32BitIndices, int32 SectionIndex, int32 LOD, bool bShouldCheckIndexType,
	...
	void CheckUpdate(int32 SectionIndex, int32 LOD, bool bShouldCheckIndexType, bool bCheckTangentVertexStream, bool bCheckUVVertexStream) const
	{
#if DO_CHECK
		bool UVsAreHighPrecision;
		int32 NumUVs;
		GetUVVertexProperties<UVType>(UVsAreHighPrecision, NumUVs);
		CheckUpdate(GetTangentIsHighPrecision<TangentType>(), UVsAreHighPrecision, NumUVs, FRuntimeMeshIndexTraits<IndexType>::Is32Bit, SectionIndex, LOD, bShouldCheckIndexType, bCheckTangentVertexStream, bCheckUVVertexStream);
#endif
	}

	template<typename VertexType0, typename VertexType1, typename VertexType2, typename IndexType>
	void CheckUpdateLegacy(int32 SectionIndex, int32 LOD, bool bShouldCheckIndexType = true) const
	{
	}
...
public:
	...
	*/
	...
	void CreateMeshSection(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<IndexType>& InTriangles, bool bCreateCollision = false,
		EUpdateFrequency UpdateFrequency = EUpdateFrequency::Average, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		...
		CreateMeshSection(SectionIndex, LOD, bWantsHighPrecisionTangents, bWantsHighPrecisionUVs, NumUVs, bUsing32BitIndices, bCreateCollision, UpdateFrequency);

		auto Mesh = BeginSectionUpdate(SectionIndex, LOD, UpdateFlags);
	...
	template<typename VertexType0, typename IndexType>
	void CreateMeshSection(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<IndexType>& InTriangles, const FBox& BoundingBox,
	...
	void CreateMeshSectionDualBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<VertexType1>& InVertices1, TArray<IndexType>& InTriangles, bool bCreateCollision = false,
		EUpdateFrequency UpdateFrequency = EUpdateFrequency::Average, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	template<typename VertexType0, typename VertexType1, typename IndexType>
	void CreateMeshSectionDualBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<VertexType1>& InVertices1, TArray<IndexType>& InTriangles, const FBox& BoundingBox,
		bool bCreateCollision = false, EUpdateFrequency UpdateFrequency = EUpdateFrequency::Average, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	template<typename VertexType0, typename VertexType1, typename VertexType2, typename IndexType>
	void CreateMeshSectionTripleBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<VertexType1>& InVertices1, TArray<VertexType2>& InVertices2, TArray<IndexType>& InTriangles,
		bool bCreateCollision = false, EUpdateFrequency UpdateFrequency = EUpdateFrequency::Average, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	void UpdateMeshSection(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_UpdateMeshSection_NoTriangles);

		FRuntimeMeshScopeLock Lock(SyncRoot);

		CheckUpdateLegacy<VertexType0, FRuntimeMeshNullVertex, FRuntimeMeshNullVertex, uint16>(SectionIndex, false);
	...
	template<typename VertexType0>
	void UpdateMeshSection(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, const FBox& BoundingBox, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	template<typename VertexType0, typename IndexType>
	void UpdateMeshSection(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<IndexType>& InTriangles, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_UpdateMeshSection);

		FRuntimeMeshScopeLock Lock(SyncRoot);

		CheckUpdateLegacy<VertexType0, FRuntimeMeshNullVertex, FRuntimeMeshNullVertex, IndexType>(SectionIndex, true);
	...
	template<typename VertexType0, typename IndexType>
	void UpdateMeshSection(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<IndexType>& InTriangles,
	...
	void UpdateMeshSectionDualBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<VertexType1>& InVertices1,
		ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		...
		CheckUpdateLegacy<VertexType0, VertexType1, FRuntimeMeshNullVertex, uint16>(SectionIndex, false);
		...
		TArray<IndexType>& InTriangles, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		...
		CheckUpdateLegacy<VertexType0, VertexType1, FRuntimeMeshNullVertex, IndexType>(SectionIndex, true);
	...
	template<typename VertexType0, typename VertexType1, typename IndexType>
	void UpdateMeshSectionDualBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<VertexType1>& InVertices1, TArray<IndexType>& InTriangles,
		const FBox& BoundingBox, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	void UpdateMeshSectionTripleBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, TArray<VertexType1>& InVertices1, TArray<VertexType2>& InVertices2,
		ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		...
		CheckUpdateLegacy<VertexType0, VertexType1, VertexType2, uint16>(SectionIndex, false);
		...
		TArray<IndexType>& InTriangles, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		...
		CheckUpdateLegacy<VertexType0, VertexType1, VertexType2, IndexType>(SectionIndex, true);
	...
	template<typename VertexType0>
	void UpdateMeshSectionPrimaryBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	template<typename VertexType0>
	void UpdateMeshSectionPrimaryBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType0>& InVertices0, const FBox& BoundingBox, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
	...
	void UpdateMeshSectionSecondaryBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType1>& InVertices1, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_UpdateMeshSectionSecondaryBuffer);

		FRuntimeMeshScopeLock Lock(SyncRoot);

		CheckUpdateLegacy<FRuntimeMeshNullVertex, VertexType1, FRuntimeMeshNullVertex, uint16>(SectionIndex, false);
	...
	void UpdateMeshSectionTertiaryBuffer(int32 SectionIndex, int32 LOD, TArray<VertexType2>& InVertices2, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_UpdateMeshSectionTertiaryBuffer);

		FRuntimeMeshScopeLock Lock(SyncRoot);

		CheckUpdateLegacy<FRuntimeMeshNullVertex, FRuntimeMeshNullVertex, VertexType2, uint16>(SectionIndex, false);
	...
	void UpdateMeshSectionTriangles(int32 SectionIndex, int32 LOD, TArray<IndexType>& InTriangles, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None)
	{
		SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_UpdateMeshSectionTriangles);

		FRuntimeMeshScopeLock Lock(SyncRoot);

		CheckUpdateLegacy<FRuntimeMeshNullVertex, FRuntimeMeshNullVertex, FRuntimeMeshNullVertex, IndexType>(SectionIndex, true);
	...
	void CreateMeshSection(int32 SectionIndex, int32 LOD, const TSharedPtr<FRuntimeMeshBuilder>& MeshData, bool bCreateCollision = false,
		EUpdateFrequency UpdateFrequency = EUpdateFrequency::Average, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None);

	void CreateMeshSectionByMove(int32 SectionIndex, int32 LOD, const TSharedPtr<FRuntimeMeshBuilder>& MeshData, bool bCreateCollision = false,
		EUpdateFrequency UpdateFrequency = EUpdateFrequency::Average, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None);



	void UpdateMeshSection(int32 SectionIndex, int32 LOD, const TSharedPtr<FRuntimeMeshBuilder>& MeshData, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None);

	void UpdateMeshSectionByMove(int32 SectionIndex, int32 LOD, const TSharedPtr<FRuntimeMeshBuilder>& MeshData, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None);





	TUniquePtr<FRuntimeMeshScopedUpdater> BeginSectionUpdate(int32 SectionIndex, int32 LOD, ESectionUpdateFlags UpdateFlags = ESectionUpdateFlags::None);

	TUniquePtr<FRuntimeMeshScopedUpdater> GetSectionReadonly(int32 SectionIndex, int32 LOD);
...
private:
	void CreateMeshSectionFromComponents(int32 SectionIndex, int32 LOD, const TArray<FVector>& Vertices, const TArray<int32>& Triangles, const TArray<FVector>& Normals,
	...
	void UpdateMeshSectionFromComponents(int32 SectionIndex, int32 LOD, const TArray<FVector>& Vertices, const TArray<int32>& Triangles, const TArray<FVector>& Normals,
...
public:
	...
	void CreateMeshSection(int32 SectionIndex, int32 LOD, const TArray<FVector>& Vertices, const TArray<int32>& Triangles, const TArray<FVector>& Normals,
	...
	void UpdateMeshSection(int32 SectionIndex, int32 LOD, const TArray<FVector>& Vertices, const TArray<FVector>& Normals, const TArray<FVector2D>& UV0,
	...
	void UpdateMeshSection(int32 SectionIndex, int32 LOD, const TArray<FVector>& Vertices, const TArray<int32>& Triangles, const TArray<FVector>& Normals,
	...
	template<typename IndexType>
	void SetSectionTessellationTriangles(int32 SectionIndex, int32 LOD, const TArray<IndexType>& Triangles)
	{
		SCOPE_CYCLE_COUNTER(STAT_RuntimeMesh_SetSectionTessellationTriangles);

		FRuntimeMeshScopeLock Lock(SyncRoot);
		CheckUpdate(false, false, 0, FRuntimeMeshIndexTraits<IndexType>::Is32Bit, SectionIndex,LOD, true, false, false);
		...
		if (Triangles.Num() > 0)
		{
			Section->UpdateAdjacencyIndexBuffer(Triangles,LOD);
		...
		{
			UpdateSectionInternal(SectionIndex, LOD, BuffersToUpdate, ESectionUpdateFlags::None);
		}
	}
	...
	/** D11.SC Release the memory stored in the internel mesh section buffers */
	void ClearAllMeshSectionBuffers();
	...
	void TransferMeshCollisionSection(int32 CollisionSectionIndex, TArray<FVector>& Vertices, TArray<int32>& Triangles); //transfer The mesh arrays ownership
...
private:
	...
	template<typename TangentType, typename UVType, typename IndexType>
	FRuntimeMeshSectionPtr CreateOrResetSection(int32 SectionIndex, int32 LOD, EUpdateFrequency UpdateFrequency)
	{
		...
		return CreateOrResetSection(SectionIndex, LOD, GetTangentIsHighPrecision<TangentType>(), bHighPrecisionUVs, NumUVs, FRuntimeMeshIndexTraits<IndexType>::Is32Bit, UpdateFrequency);
	}

	FRuntimeMeshSectionPtr CreateOrResetSection(int32 SectionIndex, int32 LOD, bool bInUseHighPrecisionTangents, bool bInUseHighPrecisionUVs,
		int32 InNumUVs, bool b32BitIndices, EUpdateFrequency UpdateFrequency);

	FRuntimeMeshSectionPtr CreateOrResetSectionForBlueprint(int32 SectionIndex, int32 LOD, bool bWantsSecondUV,
	...
	void CreateSectionInternal(int32 SectionIndex, int32 LOD, ESectionUpdateFlags UpdateFlags);

	/* Finishes updating a section, including entering it for batch updating, or updating the RT directly */
	void UpdateSectionInternal(int32 SectionIndex, int32 LOD, ERuntimeMeshBuffersToUpdate BuffersToUpdate, ESectionUpdateFlags UpdateFlags);

	/* Handles things like automatic tessellation and tangent calculation that is common to both section creation and update. */
	void HandleCommonSectionUpdateFlags(int32 SectionIndex, int32 LOD, ESectionUpdateFlags UpdateFlags, ERuntimeMeshBuffersToUpdate& BuffersToUpdate);
	...
	TSharedPtr<const FRuntimeMeshAccessor> GetReadonlyMeshAccessor(int32 SectionIndex, int32 LOD);
