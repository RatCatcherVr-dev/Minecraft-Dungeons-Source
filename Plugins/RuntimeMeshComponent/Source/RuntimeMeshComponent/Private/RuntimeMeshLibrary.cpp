...
void URuntimeMeshLibrary::CopyStaticMeshToRuntimeMesh(UStaticMeshComponent* StaticMeshComponent, int32 LODIndex, URuntimeMesh* RuntimeMesh, bool bCreateCollision)
{
		...
		RuntimeMesh != nullptr)
	{
		...
		for (int32 SectionIndex = 0; SectionIndex < NumSections; SectionIndex++)
		{
			...
			// Create RuntimeMesh
			RuntimeMesh->CreateMeshSection(SectionIndex, LODIndex, MeshData, bCreateCollision);
			RuntimeMesh->SetSectionTessellationTriangles(SectionIndex, LODIndex, AdjacencyTriangles);
		}
