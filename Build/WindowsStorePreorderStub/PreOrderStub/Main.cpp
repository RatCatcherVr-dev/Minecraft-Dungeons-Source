...
// Main.cpp
//
// Entry point for "Project Antibes" for Desktop.
//
...
LPCWSTR g_szAppName = L"Minecraft Dungeons";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    if (FAILED(hr))
    {
        ...
        {
            (void)MessageBoxW(nullptr, L"Game Runtime is not installed on this system.", g_szAppName, MB_ICONERROR | MB_OK);
        }
        return 1;
    }
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"PreOrderStubWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PreOrderStubWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"PreOrderStubWindowClass", g_szAppName, WS_POPUP,
