...
{
#ifdef _GAMING_XBOX
    #include "Shaders/Compiled/XboxGamingDebugEffect_VSDebug.inc"
    #include "Shaders/Compiled/XboxGamingDebugEffect_VSDebugVc.inc"

    #include "Shaders/Compiled/XboxGamingDebugEffect_VSDebugBn.inc"
    #include "Shaders/Compiled/XboxGamingDebugEffect_VSDebugVcBn.inc"

    #include "Shaders/Compiled/XboxGamingDebugEffect_PSHemiAmbient.inc"
    #include "Shaders/Compiled/XboxGamingDebugEffect_PSRGBNormals.inc"
    #include "Shaders/Compiled/XboxGamingDebugEffect_PSRGBTangents.inc"
    #include "Shaders/Compiled/XboxGamingDebugEffect_PSRGBBiTangents.inc"
