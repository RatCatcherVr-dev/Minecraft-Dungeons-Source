...
{
#ifdef _GAMING_XBOX
    #include "Shaders/Compiled/XboxGamingPostProcess_VSQuadDual.inc"

    #include "Shaders/Compiled/XboxGamingPostProcess_PSMerge.inc"
    #include "Shaders/Compiled/XboxGamingPostProcess_PSBloomCombine.inc"
