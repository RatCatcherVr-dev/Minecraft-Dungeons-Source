...
namespace
{
    ...
    #ifdef _GAMING_XBOX
    #include "Shaders/Compiled/XboxGamingSpriteEffect_SpriteVertexShader.inc"
    #include "Shaders/Compiled/XboxGamingSpriteEffect_SpritePixelShader.inc"
    #include "Shaders/Compiled/XboxGamingSpriteEffect_SpriteVertexShaderHeap.inc"
    #include "Shaders/Compiled/XboxGamingSpriteEffect_SpritePixelShaderHeap.inc"
